...
public final class TrustedDestinationMatcher {
    ...
    public TrustedDestinationMatcher(List<String> hostPatterns) {
        this(hostPatterns, true, false);
    }

    private TrustedDestinationMatcher(List<String> globs, boolean hostMode, boolean allowIpLiterals) {
    ...
    public static TrustedDestinationMatcher forHttpHosts(List<String> hostPatterns, boolean allowIpLiterals) {
        return new TrustedDestinationMatcher(hostPatterns, true, allowIpLiterals);
    }

    public static TrustedDestinationMatcher forKafkaTopics(List<String> topicPatterns) {
        return new TrustedDestinationMatcher(topicPatterns, false, true);
    }
