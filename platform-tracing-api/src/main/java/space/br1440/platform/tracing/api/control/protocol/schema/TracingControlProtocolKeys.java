...
public final class TracingControlProtocolKeys {
    ...
    public static final String TOPOLOGY_EXPORTER_ENDPOINT = "exporter.endpoint";
    public static final String TOPOLOGY_EXPORTER_PROTOCOL = "exporter.protocol";
    public static final String TOPOLOGY_EXPORTER_QUEUE_SIZE = "exporter.queue.size";
    public static final String TOPOLOGY_SDK_MODE = "sdk.mode";
    public static final String TOPOLOGY_QUEUE_SIZE = "queue.size";

    public static final String OPERATION_APPLY_RUNTIME_POLICY = "APPLY_RUNTIME_POLICY";
    public static final String OPERATION_VALIDATE_RUNTIME_POLICY = "VALIDATE_RUNTIME_POLICY";
    public static final String OPERATION_READ_APPLIED_STATE = "READ_APPLIED_STATE";
    public static final String OPERATION_READ_SCHEMA = "READ_SCHEMA";
