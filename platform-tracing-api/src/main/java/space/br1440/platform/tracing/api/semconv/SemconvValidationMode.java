 ...
 * <p>
 * Каждый режим решает ровно одну задачу (см. {@code ADR-semconv-validation-modes}):
 * <ul>
 ...
 *       нарушением), пишется rate-limited лог и метрика нарушений. Соответствует OTel Error
 *       Handling spec («MUST NOT throw unhandled exceptions at runtime»).</li>
