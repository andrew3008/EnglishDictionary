...
/**
 * Migrated from {@code version/TracingControlProtocolVersionTest}.
 * {@link TracingControlProtocolVersion} is a public flat-package type;
 * no package-private access is required.
 */
...
class TracingControlProtocolVersionTest {
    ...
    void equalsAndHashCode() {
        ...
        TracingControlProtocolVersion otherMajor  = new TracingControlProtocolVersion(2);

        assertThat(first).isEqualTo(sameMajor);
        assertThat(first.hashCode()).isEqualTo(sameMajor.hashCode());
        assertThat(first).isNotEqualTo(otherMajor);
    }
