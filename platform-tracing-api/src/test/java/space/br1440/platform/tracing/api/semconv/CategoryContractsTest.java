...
/**
 * Semantic contract tests (PR-6): проверяют структурную целостность реестра {@link CategoryContracts}
 * как единственного источника истины для runtime-policy и линтера.
 */
class CategoryContractsTest {
    ...
    void реестрВозвращаетОдинИТотЖеЭкземпляр() {
        // assertSame-страховка: runtime-policy и линтер обязаны видеть идентичный контракт.
