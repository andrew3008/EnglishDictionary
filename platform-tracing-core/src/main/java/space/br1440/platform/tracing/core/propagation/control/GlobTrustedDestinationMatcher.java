...
/**
 * Glob-реализация {@link TrustedDestinationMatcher}.
 * <p>
 * Package-private: создаётся только через {@link TrustedDestinationMatchers}.
 * Не экспортируется в autoconfigure или otel-extension напрямую.
 */
