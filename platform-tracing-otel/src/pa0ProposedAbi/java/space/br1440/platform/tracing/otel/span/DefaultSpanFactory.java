...
/**
 * PA-0 spike: preferred composition — spec-factory владеет runtime/policy, builder-factory получает только bridge.
 */
public final class DefaultSpanFactory implements SpanFactory {
    ...
    private static OtelTraceparentReader readerFor(TracingRuntime runtime) {
