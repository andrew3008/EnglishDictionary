 ...
 * <p>
 * Внутренний тип: используется только {@link CategoryContracts} и {@link AttributePolicy}.
 * Не является частью публичного API платформы.
 */
record CategoryContract(SpanCategory category,
