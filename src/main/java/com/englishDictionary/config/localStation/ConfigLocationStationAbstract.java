...
import com.englishDictionary.config.EnvironmentInterface;

abstract class ConfigLocationStationAbstract implements EnvironmentInterface {

    // protected abstract String rootDir();
