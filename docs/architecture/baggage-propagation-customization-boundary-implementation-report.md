...
| Элемент | Состояние |
|---|---|
| Класс | `space.br1440.platform.tracing.otel.javaagent.factory.PlatformPropagatorFactory` |
...
**Файл:**  
`platform-tracing-otel-javaagent-extension/src/main/java/space/br1440/platform/tracing/otel/javaagent/propagation/BaggagePropagatorTypeDetector.java`
...
**Файл:**  
`platform-tracing-otel-javaagent-extension/src/main/java/space/br1440/platform/tracing/otel/javaagent/propagation/BaggagePropagationCustomizer.java`
...
**Удалён файл:**  
`platform-tracing-otel-javaagent-extension/src/main/java/space/br1440/platform/tracing/otel/javaagent/factory/PlatformPropagatorFactory.java`
...
**Файл:**  
`platform-tracing-otel-javaagent-extension/src/test/java/space/br1440/platform/tracing/otel/javaagent/propagation/BaggagePropagatorTypeDetectorTest.java`
...
**Файл:**  
`platform-tracing-otel-javaagent-extension/src/test/java/space/br1440/platform/tracing/otel/javaagent/propagation/BaggagePropagationCustomizerTest.java`
...
**Файл:**  
`platform-tracing-otel-javaagent-extension/src/test/java/space/br1440/platform/tracing/otel/javaagent/arch/PropagationBoundaryArchTest.java`
...
- Scope: production-классы в `space.br1440.platform.tracing.otel.javaagent..`, кроме `BaggagePropagatorTypeDetector`
