...
**Файл:**  
`platform-tracing-otel-extension/src/main/java/space/br1440/platform/tracing/otel/extension/propagation/BaggagePropagatorTypeDetector.java`
...
**Файл:**  
`platform-tracing-otel-extension/src/main/java/space/br1440/platform/tracing/otel/extension/propagation/BaggagePropagationCustomizer.java`
...
**Файл:**  
`platform-tracing-otel-extension/src/main/java/space/br1440/platform/tracing/otel/extension/PlatformAutoConfigurationCustomizer.java`
...
**Файл:**  
`platform-tracing-otel-extension/src/test/java/space/br1440/platform/tracing/otel/extension/propagation/BaggagePropagatorTypeDetectorTest.java`
...
**Файл:**  
`platform-tracing-otel-extension/src/test/java/space/br1440/platform/tracing/otel/extension/propagation/BaggagePropagationCustomizerTest.java`
...
**Файл:**  
`platform-tracing-otel-extension/src/test/java/space/br1440/platform/tracing/otel/extension/arch/PropagationBoundaryArchTest.java`
...
- `./gradlew :platform-tracing-otel-extension:test` — **BUILD SUCCESSFUL**;
